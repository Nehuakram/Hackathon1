...
const LeatestProducts = () => {
  const products = [
    {name: "Leatest Product2",
      price: "$42.00",
      priceWas: "$65",
      image: "/Leatest product1.png", // Replace with actual image paths
    },
    {
      name: "Leatest Product2",
      price: "$42.00",
      priceWas: "$65",
      image: "/Leatest product2.png",
    },
    {
      name: "Leatest Product3",
      price: "$42.00",
      priceWas: "$65",
      image: "/Leatest product3.png",
    },

    {
      name: "Leatest Product4",
      price: "$42.00",
      priceWas: "$65",
      image: "/Leatest product4.png", // Replace with actual image paths
    },
    {
      name: "Leatest Product5",
      price: "$42.00",
      priceWas: "$65",
      image: "/Leatest product5.png",
    },
    {
      name: "Leatest Product6",
      price: "$42.00",
      priceWas: "$65",
      image: "/Leatest product6.png",
    },
